...
('Delivery Staff',25000,'Delivery staff hourly wage'),
('Cashier',30000,'Cashier hourly wage'),
('Pizza Chef',40000,'Chef wage'),
('Senior Chef',50000,'Senior chef wage'),
('Store Manager',60000,'Store manager wage'),
('Cleaner',22000,'Cleaning staff'),
('Supervisor',45000,'Shift supervisor'),
('Marketing Staff',28000,'Marketing staff'),
('Accountant',35000,'Accounting staff'),
('IT Support',38000,'IT and system support'),
('customer',0,'No salary level');
...
('Morning Shift','2025-01-01 08:00','2025-01-01 12:00',1.0,0),
('Lunch Shift','2025-01-01 12:00','2025-01-01 16:00',1.0,0),
('Evening Shift','2025-01-01 16:00','2025-01-01 20:00',1.1,20000),
('Night Shift','2025-01-01 18:00','2025-01-01 22:00',1.2,30000),
('Late Night','2025-01-01 22:00','2025-01-02 02:00',1.5,50000),
('Weekend Morning','2025-01-04 08:00','2025-01-04 12:00',1.2,20000),
('Weekend Evening','2025-01-04 16:00','2025-01-04 22:00',1.3,30000),
('Holiday Morning','2025-04-30 08:00','2025-04-30 12:00',1.5,50000),
('Holiday Evening','2025-04-30 16:00','2025-04-30 22:00',1.6,60000),
('Training Shift','2025-01-02 09:00','2025-01-02 12:00',1.0,0);
...
('marketing','Marketing','web',NOW(),NOW()),
('hr','HR','web',NOW(),NOW()),
('accountant','Accountant','web',NOW(),NOW()),
('viewer','Viewer','web',NOW(),NOW());

-- đang text kiểm tra lại ?????
