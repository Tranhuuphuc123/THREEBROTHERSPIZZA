...
import {ShiftTypes, ApiResponseTypes} from '@/types/ShiftTypes'
...
export default function SalaryLevelManage () {
  ...
  */
  ...
  const canCreate = strPermission.includes(SHIFT_CREATE);
  const canUpdate = strPermission.includes(SHIFT_EDIT);
  const canDelete = strPermission.includes(SHIFT_DELTE);
