...
import {PRODUCT_CREATE, PRODUCT_UPDATE, PRODUCT_DELETE} from '@/constants/permissionsName'
...
export default function ProductManage () {
  ...
  */
  ...
  const canCreate = strPermission.includes(PRODUCT_CREATE);
  const canUpdate = strPermission.includes(PRODUCT_UPDATE);
  const canDelete = strPermission.includes(PRODUCT_DELETE);
        ...
        <div className="row align-items-center mb-3 mx-1">
          <div className="col-sm-12 p-0">
            ...
            <div className="form-group">
              <label className="me-2">Name Products</label>
              <input
                type="text"
