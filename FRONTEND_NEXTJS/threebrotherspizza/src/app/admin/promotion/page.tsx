...
import {PromotionTypes, ApiResponseTypes} from '@/types/PromotionTypes'
...
//import page form create product(form create tự thiết kế bằng bootstrap)
 import CreateModal from "@/app/admin/promotion/create/page";
//import page form delete product
import DeleteModal from "@/app/admin/promotion/delete/page";
// //import form edit products
 import EditModal from "@/app/admin/promotion/edit/page";
...
import {PROMOTIONS_CREATE, PROMOTIONS_EDIT, PROMOTIONS_DELETE} from '@/constants/permissionsName'
...
export default function SupplierManage () {
  ...
  const [listPromotion, setListPromotion] = useState<PromotionTypes[]>([]);
  ...
  */
  ...
  const canCreate = strPermission.includes(PROMOTIONS_CREATE);
  const canUpdate = strPermission.includes(PROMOTIONS_EDIT);
  const canDelete = strPermission.includes(PROMOTIONS_DELETE);
  ...
  const fetchPromotion = async () => {
    const res = await axiosAdmin.get<ApiResponseTypes>('/promotions', {
      params: {
  ...
  return (
    ...
    <>
      ...
      <div className="card p-3 manage-employees">
        <div className="row align-items-center mb-3 mx-1">
          <div className="col-sm-12 p-0">
            <h5 className="ml-lg-2">Filter Search</h5>
            <div className="form-group">
              <label className="me-2">Promotion Name</label>
              <input
                type="text"
      ...
      {/* giao diện table Promotion */}
      <div className="card p-3 manage-employees">
        <div className="row align-items-center mb-3 mx-1">
          <div className="col-12 col-sm-6 p-0 mb-2 mb-sm-0">
            <h5 className="ml-lg-2">Manage Promotion</h5>
          </div>
