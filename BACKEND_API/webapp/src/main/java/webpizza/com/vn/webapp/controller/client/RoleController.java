...
import webpizza.com.vn.webapp.DTO.client.RoleDTO_CL.RoleCreateRequestDTO_CL;
import webpizza.com.vn.webapp.DTO.client.RoleDTO_CL.RoleUpdateRequestDTO_CL;
import webpizza.com.vn.webapp.service.client.RoleServiceCL;
...
public class RoleController {
    ...
    * */
    ...
    public ResponseEntity<Map<String, Object>> getAll(@RequestParam(defaultValue = "1") Integer pageNumber,
        ...
        return roleServiceCL.getAllRole(pageNumber, pageSize, sortBy);
    }
