...
import webpizza.com.vn.webapp.service.admin.FeedbackServiceAD;

@RestController
@RequestMapping("/api/admin/feedbacks")
public class FeedbackControllerAD {
    @Autowired
    private FeedbackServiceAD feedbackServiceAD;
    ...
    * */
    ...
    public ResponseEntity<Map<String, Object>> index(@RequestParam(defaultValue = "1") Integer pageNumber,
                                                    ...
                                                    @RequestParam(required = false) Number search){
        // goi service thuc hien truy van hien thi tat ca thong tin cua table user co phan trang
        return feedbackServiceAD.getAllFeedbackPagination(pageNumber, pageSize, sortBy, search);
    }
    ...
    public ResponseEntity<Map<String, Object>> getById(@PathVariable Integer id){
        ...
        return feedbackServiceAD.getById(id);
    }
    ...
    /* II - create */
     //@CrossOrigin(origins = "${client.url}") 
    @PostMapping("/create")
        public ResponseEntity<Map<String, Object>> create(@Valid @RequestBody FeedbackCreateRequestDTO_AD objCreate){
            try{
                return feedbackServiceAD.createFeedback(objCreate);
            }catch(Exception ex){
    ...
    public ResponseEntity<Map<String, Object>> delete(@PathVariable Integer id){
        return feedbackServiceAD.deleteFeedback(id);
    }
    ...
    public ResponseEntity<Map<String, Object>> update(@PathVariable Integer id, @RequestBody FeedbackUpdateRequestDTO_AD objUpdate){
        return feedbackServiceAD.updateFeedback(id, objUpdate);
    }
}
